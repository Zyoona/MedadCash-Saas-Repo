-- Add new audit actions for SystemModule (export-zip, import-zip, wipe-demo)
...
ALTER TABLE "audit_logs" ADD CONSTRAINT "audit_logs_action_check" CHECK ("action" IN (
  ...
  'backup_export','import_zip','wipe_demo','import_zip_images_skipped','import_zip_images_failed'
));