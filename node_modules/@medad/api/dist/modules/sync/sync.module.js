...
exports.SyncModule = SyncModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [sync_service_js_1.SyncService, backup_service_js_1.LocalBackupProvider, backup_service_js_1.DriveBackupProvider, backup_service_js_1.BackupService],
        exports: [sync_service_js_1.SyncService, backup_service_js_1.BackupService],
    })
], SyncModule);
